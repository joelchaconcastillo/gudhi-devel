...
#ifndef CONCEPT_DOWKER_COMPLEX_SIMPLICIAL_COMPLEX_FOR_DOWKER_H_
#define CONCEPT_DOWKER_COMPLEX_SIMPLICIAL_COMPLEX_FOR_DOWKER_H_
...
#endif  // CONCEPT_DOWKER_COMPLEX_SIMPLICIAL_COMPLEX_FOR_DOWKER_H_
